...
/**
 * Classe responsável por agrupar os métodos comuns de validação
 * @author Oseas Moreto
 */
class Validator{
    ...
    /** Método responsável por validar CPF ou CNPJ
     * @method static cpfOuCnpj
     * @param  string $cpfoucnpj
     * @return bool|mixed
     */
    public static function cpfOuCnpj($cpfoucnpj){
        //Caso seja CNPJ
        if(strlen($cpfoucnpj) == 11) {
            return self::validaCpf($cpfoucnpj);
        }
    
        //Caso seja CPF
        if(strlen($cpfoucnpj) == 14) {
            return self::validaCnpj($cpfoucnpj);
        }
    }

    /** Método responsável por validar CNPJ
     * @method static validaCnpj
     * @param  string $cnpj
     * @return bool|mixed
     */
     ...
     *
     */
    public static function multiplica_cnpj($cnpj, $posicao = 5) {
     ...
     * @return mixed Os dígitos enviados concatenados com o último dígito
     *
     */
